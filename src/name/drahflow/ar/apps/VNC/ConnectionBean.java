 ...
 *
 */
class ConnectionBean extends ConnectionBeanStorage implements Comparable<ConnectionBean> {
	...
	public boolean getFollowPan() { return false; }
	public boolean getFollowMouse() { return false; }
}

...
class FullBufferBitmapData extends AbstractBitmapData {
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#copyRect(android.graphics.Rect, android.graphics.Rect, android.graphics.Paint)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#createDrawable()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#drawRect(int, int, int, int, android.graphics.Paint)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#offset(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#scrollChanged(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#syncScroll()
	 */
	@Override
	void syncScroll() {
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#updateBitmap(int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#validDraw(int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see name.drahflow.ar.apps.VNC.AbstractBitmapData#writeFullUpdateRequest(boolean)
	 */
	@Override
